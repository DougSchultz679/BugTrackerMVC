    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.UpdateUserInfoSuccess ?"Your user information has successfully been updated."
                : message== ManageMessageId.UpdateUserInfoError?"Your user information was not updated. Please try again later."
                :"";
